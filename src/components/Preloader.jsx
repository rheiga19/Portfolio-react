...
const Preloader = ({ onFinished }) => {
  ...
  const fullText = "www.rheiga-portfolio.id";
        ...
        >
          ...
          {showContent && (
            ...
            >
              ...
              >
                <a href="https://github.com/rheiga23" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <Github size={32} />
                </a>
                <a href="https://www.linkedin.com/in/rheiga-ruhul-qudus-3149b2323/" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <Linkedin size={32} />
                </a>
                <a href="https://www.instagram.com/rheiga.rq_19" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <Instagram size={32} />
                </a>
              </motion.div>
            </motion.div>
